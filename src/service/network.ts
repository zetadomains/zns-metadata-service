...
export default function getNetwork(network: NetworkName): {
  ...
  switch (network) { 
    case NETWORK.GOERLI:
      SUBGRAPH_URL =
        'http://graphql.local.com/subgraphs/name/zetadomains/zeta-subgraph-goerli';
      break;
    case NETWORK.MAINNET:
      SUBGRAPH_URL = '';
      break;
    case NETWORK.ZETACHAIN:
      SUBGRAPH_URL = 'https://graphql.zeta.domains/subgraphs/name/zetadomains/zeta-subgraph';
      break;
    default:
