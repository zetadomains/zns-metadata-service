...
const zeta =
  '0x4c1ec05bdc3ef5e1b7c37e350b926690b2fdaba933c1c608ab5e03737097cd79'; // ZETA_NODE
...
export async function getDomain(
  ...
  async function requestMedia(isAvatarExist: boolean) {
    if (loadImages) {
      ...
      //  `https://metadata.zeta.domains/${networkName}/avatar/${name}`
      //);
      metadata.setImage(
        `https://metadata.zeta.domains/${networkName}/${contractAddress}/${hexId}/image`
      );
    }
  }
