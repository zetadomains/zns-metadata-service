...
const ADDRESS_ETH_REGISTRAR = process.env.ADDRESS_ETH_REGISTRAR || '0xCEeCD6AF7c1504410c527EdEf163920e9F18BEbF';
const ADDRESS_ETH_REGISTRY = process.env.ADDRESS_ETH_REGISTRY || '0x73C5857a7710A7EF3bc32EfA32C8a2ba2827A211';
